...
- The canvas is per document: 1:1 (`IG_SQUARE`) or 4:5 (`IG_PORTRAIT`, 1080×1350 — TMZ, What My Apps). Nothing else in the pipeline assumes a square; `reflowStacks` and the renderers read `doc.canvas`.
