...
**Status:** Blocked on product decisions (see open questions below). Do
not start implementation until Pat answers all three.
...
**Open product questions (block implementation):**
