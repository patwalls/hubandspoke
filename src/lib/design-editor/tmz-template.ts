 ...
 * (Sept 2026; the one format Pat keeps vertical): a still of the founder
 * over the top ~55%, a black band below with a three-line first-person
 * quote in condensed all-caps
 ...
 * story.
 */
import { IG_PORTRAIT, newElementId, type DesignDoc, type DesignElement, type DesignPage } from "./doc";
