/**
 * The "What My Apps Are & What They Do" preset — a square carousel modelled
 * on the format's best posts (Sept 2026; e.g. "I built 5 'boring' apps that
 * make $200K/month" — published at 4:5, laid out here as the square every
 * design here is):
...
export function buildAppsCover(): DesignPage {
  ...
  elements.push(
    text("Headline", { x: 50, y: 600, w: W - 100, h: 340 }, applyHighlights("I built 5 \"boring\" apps that make $200K/month", [{ phrase: "$200K/month", color: "green" }]), baseText({
      fontId: "anton", sizePx: 92, lineHeight: 1.06, align: "center", valign: "bottom", uppercase: true, autoFit: true, minSizePx: 48,
    ...
    text("Footer", { x: 60, y: 975, w: W - 120, h: 50 }, [{ text: "My apps and what they do →" }], baseText({ fontId: "inter-regular", sizePx: 34, lineHeight: 1.2, align: "center", autoFit: true, minSizePx: 20 }), { slot: ai("\"My apps and what they do →\" / \"My app and what it does ↓\" / \"Her apps and what they do →\" — matching the founder and the count, ending with →.") }),
  );
